...
export default function Home() {
  ...
  const latestWritingHref =
    "https://open.substack.com/pub/ripleymedia/p/the-agentic-shift-is-simple-economics?utm_campaign=post-expanded-share&utm_medium=web";
  ...
  return (
    <main className="min-h-screen bg-white text-zinc-900">
      ...
      >
        <div className="border-b border-zinc-200 bg-white/90 shadow-sm backdrop-blur">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 rounded-2xl border border-zinc-200 bg-zinc-50 p-6 text-left">
            ...
            <p className="mt-2 text-sm text-zinc-700">
              ...
              — built around packaging readiness, workflow friction removal, and pilots tied to
              revenue outcomes.
            </p>
      ...
      <section className="bg-zinc-50">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <div className="flex flex-wrap items-end justify-between gap-3">
            <div>
              ...
              <p className="mt-3 max-w-3xl text-zinc-700">
                Fresh thinking in plain English on agentic AI, market structure, and what actually
          ...
          <div className="mt-8 rounded-2xl border border-zinc-200 bg-white p-8">
            <p className="text-xs font-medium text-zinc-600">Featured post • Substack</p>

            <h3 className="mt-3 text-2xl font-semibold tracking-tight">
              The Agentic Shift Is Simple Economics
            </h3>

            <p className="mt-4 max-w-3xl text-zinc-700">
              A simpler way to think about the agentic shift: less standards drama, more economics.
              Lower transaction costs, less manual work, and more money kept by buyers and sellers.
            </p>

            <div className="mt-5 flex flex-wrap gap-2">
              {["Agentic", "Economics", "CTV", "Programmatic"].map((tag) => (
                <span
                  key={tag}
      ...
      <section id="services">
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <p className="mt-3 max-w-3xl text-zinc-700">
            A practical operator's approach: inventory + packaging readiness, partner workflows, and
            a pilot path that drives revenue outcomes.
          </p>
      ...
      <section id="contact">
        <div className="mx-auto max-w-6xl px-6 py-16">
          <div className="rounded-2xl border border-zinc-200 p-8">
            ...
            <p className="mt-3 max-w-3xl text-zinc-700">
              If you want agentic workflows that translate into real revenue, let’s do a short call
